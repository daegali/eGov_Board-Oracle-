									...
									<div>
										<div class="row">
											<div class="col-6 col-12-medium">
												<input type="text" name="title"  id="title" placeholder="제목"  value="${boardDetail.title}"/>
											</div>
											<div class="col-12">
												<input type="text" name="name"  id="name" placeholder="글쓴이"  value="${boardDetail.name }"  readonly="readonly"/>
											</div>
											<div class="col-12">
												<textarea name="content"   id="content"  placeholder="내용" rows="6" >${boardDetail.content }</textarea>
											</div>
											<div class="col-12">
